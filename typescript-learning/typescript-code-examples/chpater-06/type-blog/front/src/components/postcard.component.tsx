    ...
    return(
        ...
        >
            <CardBody>
                <Image
                    src={
                        props.thumbnail ?? "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80"
                    }
                    alt="thumbnail"
                    borderRadius="lg"
                />
                <Stack mt="6" spacing="3">
                    ...
                    <Text color="gray.400" fontSize="me">
                        {props.createdAt
